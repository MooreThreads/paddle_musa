...
#define REGISTER_LOGICAL_MUSA_KERNEL(logical_and, func_type) \
...
REGISTER_LOGICAL_MUSA_KERNEL(logical_and, And)
REGISTER_LOGICAL_MUSA_KERNEL(logical_or, Or)
REGISTER_LOGICAL_MUSA_KERNEL(logical_not, Not)
REGISTER_LOGICAL_MUSA_KERNEL(logical_xor, Xor)
