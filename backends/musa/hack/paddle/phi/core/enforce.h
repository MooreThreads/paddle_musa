...
inline std::string build_nvidia_error_msg(mublasStatus_t stat) {
  std::ostringstream sout;
  sout << "MUBLAS error(" << stat << "). " << GetExternalErrorMsg(stat);
  return sout.str();
}
