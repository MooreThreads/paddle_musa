...
class TestCollectiveAPIRunnerBase:
    ...
    def run_trainer(self, args):
        ...
        if args['backend'] == 'xccl':
            device_id = int(os.getenv("FLAGS_selected_musas", "0"))
...
class TestDistBase(unittest.TestCase):
    ...
    def _run_cluster(self, model_file, envs):
        ...
        if core.is_compiled_with_cuda() or is_custom_device():
            ...
            "MCCL_DEBUG_FILE": "/tmp/mccl_rank0.log",
            "MCCL_DEBUG": "INFO",
            "MCCL_DEBUG_SUBSYS": "ALL",
            "FLAGS_selected_musas": "0",
            ...
            env1 = {
                ...
                "MCCL_DEBUG_FILE": "/tmp/mccl_rank1.log",
                "MCCL_DEBUG": "INFO",
                "MCCL_DEBUG_SUBSYS": "ALL",
                "FLAGS_selected_musas": "1",
        ...
        path0 = os.path.join(
            self.temp_dir.name, f"/tmp/tr0_err_0.log"
        )
        path1 = os.path.join(
            self.temp_dir.name, f"/tmp/tr1_err_1.log"
        )
    ...
    def check_with_place(
        ...
        if backend == "xccl" or backend == "bkcl":
            with_gloo = '0'
        else:
            with_gloo = '1'
